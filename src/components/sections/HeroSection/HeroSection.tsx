        ...
        <div className={styles.hero}>
            <div className ={styles.heroHead}>
                <div className={styles.heroHead_est}>
                    <p>EST 21.12.24</p>
                <small>A place where design philosophy blends innovation and clarity to create impactful solutions</small>
                </div>
                <Image src={barcode} alt='barcode'/>
            </div>
            <h1 className={styles.heroTitle}>The Art of Bold
            Precision</h1>
...
DISCOVER OUR WORK
<Image src={arrowDownHero} alt='arrow' className={styles.heroFooter_arrow}/>
</a>
        </div>
        </div>
    );
