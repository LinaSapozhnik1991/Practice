...
const FeatureTextHover: React.FC<FeatureTextHoverProps> = ({ activeFeature,features}) => {
    
    const activeFeatureName = features.find((feature: { id: string | null; }) => feature.id === activeFeature)?.name;
