В вашем описании проекта есть несколько мест, где можно добавить синтаксис для bash, чтобы улучшить читаемость и структурировать инструкции. Вот обновленный текст с добавленным форматированием для bash:
